...
public class ContatoAdapter extends BaseAdapter
{
    ...
    // Lógica para distribuir os dados da List com a View
    @Override
    public View getView(int i, View view, ViewGroup viewGroup)
    {
        ...
        View v = layoutInflater.inflate(R.layout.listview_contato, null); // Infla a view e permite manipular seus objetos
